...
[SEGMENT .data]
    strWelcomeMsg   db  "Hello Welcome to Pathum_OS - Enter help to display commands", 0x00
	strPrompt		db	"Pathum_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Pathum_OS", 0x00	;OS details
	...
	strHelpMsg2		db  "Input info for displaying Hardware information of the system",0x00
